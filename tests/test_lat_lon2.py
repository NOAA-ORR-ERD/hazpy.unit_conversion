...
import hazpy.unit_conversion.lat_long as ll



# #### Base classes ####
# class BaseTestIncident(object):
#     """Subclasses must set:

#     * lat, lon: float.
#     * latf, lonf: expected formatted output, degrees & minutes.
#     """

#     def test_format_lat(self):
#         assert ll.format_lat(self.lat) == self.latf

#     def test_format_lon(self):
#         assert ll.format_lon(self.lon) == self.lonf

## degrees, minutes, formatting:
